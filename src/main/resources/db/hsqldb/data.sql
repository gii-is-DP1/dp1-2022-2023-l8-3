...
INSERT INTO achievements(id,name,metrics,threshold,description,visibility,difficulty) VALUES
	(1, 'Viciado', 'JUGAR_PARTIDAS', 10.0, 'Si juegas <THRESHOLD> partidas o más, consideramos que ya estás enganchado', 'PUBLICADO', 'PLATA'),
	(2, 'Triunfador', 'GANAR_PARTIDAS', 20.0, 'Si ganas <THRESHOLD> o más partidas es que eres todo un triunfador', 'PUBLICADO', 'PLATA'),
	(3, 'La primera de muchas', 'GANAR_PARTIDAS', 1.0, 'Has ganado tu primera partida', 'EN_BORRADOR', 'BRONCE'),
	(4, 'Comenzando', 'JUGAR_PARTIDAS', 1.0, 'Has jugado tu primera partida', 'PUBLICADO', 'BRONCE');
...
VALUES(1, 'Primera partida', 1, 2, false, true, '1999-04-12 10:12:12.55', '1999-04-12 10:15:12.32', 'DRAW', 6, 6, 9, 9, 4, 4, 20);
INSERT INTO disco(id,num_bacteria_j1,num_bacteria_j2,num_sarcina_j1,num_sarcina_j2,num_movimientos_j1,num_movimientos_j2,id_match) VALUES(1,4,0,0,0,0,3,1);
INSERT INTO disco(id,num_bacteria_j1,num_bacteria_j2,num_sarcina_j1,num_sarcina_j2,num_movimientos_j1,num_movimientos_j2,id_match) VALUES(2,1,3,0,0,6,2,1);
INSERT INTO disco(id,num_bacteria_j1,num_bacteria_j2,num_sarcina_j1,num_sarcina_j2,num_movimientos_j1,num_movimientos_j2,id_match) VALUES(3,2,1,0,0,3,0,1);
INSERT INTO disco(id,num_bacteria_j1,num_bacteria_j2,num_sarcina_j1,num_sarcina_j2,num_movimientos_j1,num_movimientos_j2,id_match) VALUES(4,0,3,0,0,4,1,1);
INSERT INTO disco(id,num_bacteria_j1,num_bacteria_j2,num_sarcina_j1,num_sarcina_j2,num_movimientos_j1,num_movimientos_j2,id_match) VALUES(5,0,0,0,0,0,3,1);
INSERT INTO disco(id,num_bacteria_j1,num_bacteria_j2,num_sarcina_j1,num_sarcina_j2,num_movimientos_j1,num_movimientos_j2,id_match) VALUES(6,2,0,0,0,8,0,1);
INSERT INTO disco(id,num_bacteria_j1,num_bacteria_j2,num_sarcina_j1,num_sarcina_j2,num_movimientos_j1,num_movimientos_j2,id_match) VALUES(7,2,4,0,0,0,4,1);

INSERT INTO matches(id, name, id_jugador1, id_jugador2, abandonada, es_privada, inicio_de_partida, fin_de_partida, ganador_de_partida, contamination_number_of_player_1,
contamination_number_of_player_2, number_of_bacteria_of_player_1, number_of_bacteria_of_player_2, number_of_sarcina_of_player_1, number_of_sarcina_of_player_2, turn)
VALUES(2, 'Segunda partida', 3, 4, false, true, '1999-04-12 10:12:12.55', '1999-04-12 11:12:12.55', 'FIRST_PLAYER', 7, 9, 13, 17, 3, 2, 26);
INSERT INTO disco(id,num_bacteria_j1,num_bacteria_j2,num_sarcina_j1,num_sarcina_j2,num_movimientos_j1,num_movimientos_j2,id_match) VALUES(8,1,2,0,0,3,2,2);
INSERT INTO disco(id,num_bacteria_j1,num_bacteria_j2,num_sarcina_j1,num_sarcina_j2,num_movimientos_j1,num_movimientos_j2,id_match) VALUES(9,0,0,1,0,0,0,2);
INSERT INTO disco(id,num_bacteria_j1,num_bacteria_j2,num_sarcina_j1,num_sarcina_j2,num_movimientos_j1,num_movimientos_j2,id_match) VALUES(10,3,0,0,0,4,3,2);
...
INSERT INTO disco(id,num_bacteria_j1,num_bacteria_j2,num_sarcina_j1,num_sarcina_j2,num_movimientos_j1,num_movimientos_j2,id_match) VALUES(12,1,0,0,1,5,0,2);
INSERT INTO disco(id,num_bacteria_j1,num_bacteria_j2,num_sarcina_j1,num_sarcina_j2,num_movimientos_j1,num_movimientos_j2,id_match) VALUES(13,0,0,0,1,0,2,2);
INSERT INTO disco(id,num_bacteria_j1,num_bacteria_j2,num_sarcina_j1,num_sarcina_j2,num_movimientos_j1,num_movimientos_j2,id_match) VALUES(14,2,1,0,0,3,1,2);

INSERT INTO matches(id, name, id_jugador1, id_jugador2, abandonada, es_privada, inicio_de_partida, fin_de_partida, ganador_de_partida, contamination_number_of_player_1,
contamination_number_of_player_2, number_of_bacteria_of_player_1, number_of_bacteria_of_player_2, number_of_sarcina_of_player_1, number_of_sarcina_of_player_2, turn)
VALUES(3, 'Tercera partida', 1, 2, true, false, '2000-05-17 15:12:07.55', '2000-05-17 15:20:16.43', 'SECOND_PLAYER', 4, 3, 17, 13, 3, 3, 20);
