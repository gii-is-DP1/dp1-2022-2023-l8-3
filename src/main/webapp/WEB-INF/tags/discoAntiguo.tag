...
<div class="${clase}">
  ...
  <div class="bs1">
    <c:forEach var="b1" begin="1" end="${esteDisco.numBact1}">
      ...
      <petclinic:bacterias name="bacteriasAmover" divJugador1="${true}" turnoJugador1="${match.turnoPrimerJugador()}"
  ...
  <div class="bs2">
    <c:forEach var="b2" begin="1" end="${esteDisco.numBact2}">
      ...
      <petclinic:bacterias name="bacteriasAmover" divJugador1="${false}" turnoJugador1="${match.turnoPrimerJugador()}"
        numeroDisco="${numeroDisco}" indexBacteria="${b1}"/>
