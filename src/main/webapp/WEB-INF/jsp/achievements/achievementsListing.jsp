    ...
    <table id="achievementsTable" class="table table-striped">
        ...
        <c:forEach items="${achievements}" var="achievement">
            <tr>
                ...
                <td>
                	<a href="<c:url value="/statistics/achievements/${achievement.id}/edit" />"> <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                </td>
                <td>
                	<a href="<c:url value="/statistics/achievements/${achievement.id}/delete" />"> <span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                </td>
