...
public interface FriendRequestRepository extends CrudRepository<FriendRequest, Integer> {
	...
	@Query("SELECT fr FROM FriendRequest fr WHERE fr.jugador1.id =:jugador1Id AND fr.jugador2.id =:jugador2Id AND fr.resultado = 'TRUE'")
	public FriendRequest findFriendshipByPlayers(@Param("jugador1Id") int jugador1Id, @Param("jugador2Id") int jugador2Id);
